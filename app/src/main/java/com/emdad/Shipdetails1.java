...
public class Shipdetails1 extends AppCompatActivity {
    SharedPreferences pref;
    SharedPreferences.Editor editor;
    String id="",bid="",status="",drs_unique_id="",slipno="",city_id="",reph="";
    Spinner s1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shipdetails1);
...
//        }
        ...
        System.out.println(drs_unique_id+"city_id is"+city_id);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Shipdetails1.this);
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        {
                            Intent i = new Intent(Shipdetails1.this, Status.class);
                        ...
                        {
                            Intent i = new Intent(Shipdetails1.this, Canvas.class);
                            i.putExtra("slipno",bid);
                            i.putExtra("drs_unique_id",drs_unique_id);
                            startActivity(i);
                            finish();
        ...
        int resultCode = apiAvailability.isGooglePlayServicesAvailable(Shipdetails1.this);
        if (resultCode != ConnectionResult.SUCCESS &&
                apiAvailability.isUserResolvableError(resultCode)) {
            Dialog dialog = apiAvailability.getErrorDialog(Shipdetails1.this, resultCode,
                    900);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Shipdetails1.this, ActivityDriver.class);
                i.putExtra("slipno",bid);
                i.putExtra("drs_unique_id",drs_unique_id);
...
//                startActivity(sIntent);
                ...
                Intent i = new Intent(Shipdetails1.this, Calls.class);
                i.putExtra("rphone",reph);
                startActivity(i);
                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            }
        });
    ...
    private void startTrip(String title, String msg, String userId, String trackingId) {
        try {
            if (trackingId.isEmpty()) {
                ...
                Toast.makeText(Shipdetails1.this,"Enter valid shipment", Toast.LENGTH_LONG).show();
            }
            else if (!isNetConnected(Shipdetails1.this)) {
                // Utils.showSnack(viewRoot, getString(R.string.text_no_internet))
                Toast.makeText(Shipdetails1.this,"No Internet.", Toast.LENGTH_LONG).show();
            }
            else{
                ...
                Toast.makeText(Shipdetails1.this,R.string.txt_wait_start_trip, Toast.LENGTH_LONG).show();
    ...
    public void login()
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.URL+"?method_name=booking_detail&user_id="+id+"&booking_id="+bid+"", new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                mProgressDialog.dismiss();
                Toast.makeText(Shipdetails1.this, error.toString(), Toast.LENGTH_LONG).show();
