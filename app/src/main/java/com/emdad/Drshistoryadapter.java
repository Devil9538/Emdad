...
public class Drshistoryadapter extends RecyclerView.Adapter<Drshistoryadapter.MyViewHolder> {

    private LayoutInflater inflater;
    private ArrayList<Pickupmodel> rogerModelArrayList;
    Context mcontext;
    public Drshistoryadapter(Context ctx, ArrayList<Pickupmodel> rogerModelArrayList){
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.city.setText("DATE: "+parseDateToddMMyyyy(rogerModelArrayList.get(position).getDate())+" "+rogerModelArrayList.get(position).getPickup_delivered()+"|"+rogerModelArrayList.get(position).getTotal_awb());
...
//        }
        ...
        holder.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mcontext, Drsdetails.class);
