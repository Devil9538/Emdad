...
public class Drsdetailsadapter123 extends RecyclerView.Adapter<Drsdetailsadapter123.MyViewHolder> {

    private LayoutInflater inflater;
    private ArrayList<Pickupmodel> rogerModelArrayList;
    Context mcontext;
    public Drsdetailsadapter123(Context ctx, ArrayList<Pickupmodel> rogerModelArrayList){
...
//        }
        ...
        holder.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mcontext, Shipdetails1.class);
                System.out.println("bid is"+rogerModelArrayList.get(position).getIddd());
