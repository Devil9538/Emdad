...
public class Pickuplistadapter extends RecyclerView.Adapter<Pickuplistadapter.MyViewHolder> {

  private LayoutInflater inflater;
  private ArrayList<Pickupmodel> rogerModelArrayList;
  Context mcontext;
  public Pickuplistadapter(Context ctx, ArrayList<Pickupmodel> rogerModelArrayList){
  ...
  public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    View view = inflater.inflate(R.layout.pickupxml, parent, false);
