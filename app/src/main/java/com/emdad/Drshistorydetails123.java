...
public class Drshistorydetails123 extends AppCompatActivity {
    SharedPreferences pref;
    SharedPreferences.Editor editor;
    String id="";
    private RecyclerView recyclerView;
    ArrayList<Pickupmodel> pickupmodelslist;
    private Drsdetailsadapter123 adapter;
    private static ProgressDialog mProgressDialog;
    String uid="";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_drshistorydetails);
        ...
        adapter = new Drsdetailsadapter123(this,pickupmodelslist);
        login();
    }
    @Override
    ...
    public void login()
    {
        System.out.println(Constant.URL+"?method_name=delivered_drs_detail&drs_id="+uid+"&user_id="+id+"");
        mProgressDialog = ProgressDialog.show(this, "Details", "Loading..");
        mProgressDialog.setCancelable(false);
        mProgressDialog.show();
        RequestQueue requestQueue = Volley.newRequestQueue(this);

        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.URL+"?method_name=delivered_drs_detail&drs_id="+uid+"&user_id="+id+"&page=1&&type=N", new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                mProgressDialog.dismiss();
                Toast.makeText(Drshistorydetails123.this, error.toString(), Toast.LENGTH_LONG).show();
