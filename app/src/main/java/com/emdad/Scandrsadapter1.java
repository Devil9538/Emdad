...
public class Scandrsadapter1 extends RecyclerView.Adapter<Scandrsadapter1.MyViewHolder> {
    ...
    public Scandrsadapter1(Context ctx, ArrayList<Pickupmodel> rogerModelArrayList){
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dbHelper.Delwine123(rogerModelArrayList.get(position).getId());
                Intent myactivity = new Intent(mcontext.getApplicationContext(),ScanDrs.class);
